...
from action.land_plan_action import land_1341
...
def claim(driverControl: DriverControl, land_number: int, is_reset_position:bool):
    ...
    ## time.sleep(0.3)
    # print("reset position - UP")
    # actions.key_down(Keys.ARROW_UP).pause(2.5).key_up(Keys.ARROW_UP).perform()
    # time.sleep(0.3)
    #
    #
    # #return left
    # print("left")
    # actions.key_down(Keys.ARROW_LEFT).pause(2).key_up(Keys.ARROW_LEFT).perform()
    # time.sleep(0.3)
    ...
    # print("drill_click")
    # x_drill, y_drill = test.get_position(screen_shot_path,f'images/lands/{land_number}/drill_1_{land_number}.png')
    ...
    # time.sleep(0.5)
    # print("slugger_click")
    # x_drill, y_drill = test.get_position(screen_shot_path, f'images/lands/{land_number}/slugger_{land_number}.png')
    # actions.move_by_offset(x_drill, y_drill).click().perform()
    # time.sleep(0.3)
    # actions.move_by_offset(0 - x_drill, 0 - y_drill).perform()
    # time.sleep(0.5)
    #
    # print("egg_click")
    # actions.key_down(Keys.ARROW_RIGHT).pause(5).key_up(Keys.ARROW_RIGHT).perform()
    # screen_shot_path = f'images/screen_shot/overview_{driverControl.profile_id}.png'
    # driverControl.driver.save_screenshot(screen_shot_path)
    # x, y = test.get_position(screen_shot_path,f'images/lands/{land_number}/egg_{land_number}.png')
    # actions.move_by_offset(x, y).click().perform()
    # time.sleep(0.3)
    # actions.move_by_offset(0-x, 0-y).click().perform()
    # time.sleep(0.5)
    # actions.key_down(Keys.ARROW_LEFT).pause(3).key_up(Keys.ARROW_LEFT).perform()
    # time.sleep(0.3)
    #
    # #reset position
    # actions.key_down(Keys.ARROW_DOWN).pause(2.5).key_up(Keys.ARROW_DOWN).perform()
    # time.sleep(0.3)
    ...
    if common_action.is_show_display(driverControl):
        land_1341.claim(driverControl,land_number+1,True)
        return True
